...
strike you as either similar to or different from Python.
   ...
   1) 'and' in Python vs. '&&' in Java
  2) for loop range sets up start and stop indices
  3) 'elif' vs. 'else if'
  4) ending each line with a brace or semicolon
  5) everything is more spaced out (convention?)
